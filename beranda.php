    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Pengiriman Barang</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data - Data Pengiriman</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                             <tr>
                                <th>No.</th><th>No Resi</th><th>Nama Pengirim</th><th>Tujuan</th><th>Tanggal Masuk</th><th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
