...
<html>
    <head>
        <title>Cetak Data Penerima Barang Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA Pengiriman Perbulan   <? echo "$bulanNama $ambilthn"; ?></h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                <thead>
								<tr>
                                <th>No.</th><th>Nomor Resi</th><th>Nama Penerima</th><th>Tanggal Menerima</th><th>No HP</th><th>Kode Pos</th>
                            </tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM penerima WHERE substr(tgl_menerima,1,7)='$ambilthn-$ambilbln'";
