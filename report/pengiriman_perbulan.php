...
<html>
    <head>
        <title>Cetak Data Pengiriman Barang Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <h2>Sistem Informasi Pengiriman Barang PT.ABCD </h2>
                        ...
                        <hr>
                        <h3>DATA PENGIRIMAN BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM pengiriman WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
